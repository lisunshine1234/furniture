    ...
    a.fn.upload = function (D) {
        ...
        a(document).on("mousemove", function (G) {
            ...
            if (j) {
                ...
                if (o !== false) {
                    let a = JSON.parse($('#uploadFileResult').val())
                    const b = JSON.parse(JSON.stringify(a))
                    a.splice(o, 0, b[r.children("li").index(j)])
                    if (o > r.children("li").index(j)) {
                        a.splice(r.children("li").index(j), 1);
                    } else {
                        a.splice(r.children("li").index(j) + 1, 1);
                    }
                    $('#uploadFileResult').val(JSON.stringify(a))
        ...
        function z(i) {
            let a = JSON.parse($('#uploadFileResult').val())
            a.splice(r.children("li").index(i), 1);
            $('#uploadFileResult').val(JSON.stringify(a))
