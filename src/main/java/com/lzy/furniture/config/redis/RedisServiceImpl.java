...
public class RedisServiceImpl implements RedisService {
    ...
    public Set<String> getKeys(String key) {
        try {
            return key == null ? new HashSet<>() : redisTemplate.keys(key);
        } catch (Exception e) {
            e.printStackTrace();
            return null;
        }
     ...
     * @return 对应的多个键值
     */
    public Map<Object, Object> hashManyGet(String key) {
     ...
     */
    public boolean hashManySet(String key, Map<String, Object> map) {
        try {
     ...
     * @return true成功 false失败
     */
    public boolean hashManySet(String key, Map<String, Object> map, long time) {
        try {
            redisTemplate.opsForHash().putAll(key, map);
            if (time > 0) {
                expire(key, time);
